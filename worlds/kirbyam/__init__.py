"""
Archipelago World definition for Kirby & The Amazing Mirror Version
"""
...
from .items import KirbyAmItem, create_item_label_to_code_map, get_item_classification, offset_item_value
from .locations import (KirbyAmLocation, create_location_label_to_id_map, create_locations_by_category,
                        set_free_fly, set_legendary_cave_entrances)
from .options import (Goal, DarkCavesRequireFlash, HmRequirements, ItemPoolType, KirbyAmOptions,
...
class KirbyAmWorld(World):
    ...
    and restore peace by defeating Dark Mind.
    """
    ...
    def create_items(self) -> None:
        ...
        def convert_unrandomized_items_to_events(category: LocationCategory) -> None:
            for location in self.multiworld.get_locations(self.player):
                assert isinstance(location, KirbyAmLocation)
