"""
Functions related to AP regions for Kirby & The Amazing Mirror (see ./data/regions for region definitions)
"""
...
def create_regions(world: "KirbyAmWorld") -> Dict[str, Region]:
                ...
                try:
                    ...
                    for subcategory in subcategories:
                        ...
                        for j, species_id in enumerate(unique_species):
                            encounter_location = KirbyAmLocation(
                                world.player,
                            ...
                            encounter_location.place_locked_item(KirbyAmItem(
    ...
    for region_name, region_data in data.regions.items():
        ...
        for event_data in region_data.events:
            event = KirbyAmLocation(world.player, event_data.name, None, new_region)
            event.place_locked_item(KirbyAmItem(event_data.name, ItemClassification.progression, None, world.player))
