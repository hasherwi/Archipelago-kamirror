"""
Classes and functions related to AP locations for Kirby & The Amazing Mirror
"""
...
def create_locations_by_category(world: "KirbyAmWorld", regions: Dict[str, Region], categories: Set[LocationCategory]) -> None:
    """
...
def set_free_fly(world: "KirbyAmWorld") -> None:
...
def set_legendary_cave_entrances(world: "KirbyAmWorld") -> None:
